...
export default class RuleDB implements IRuleDB {
    ...
    private convertRuleToDBRule(rule: RuleWithCnt | apid.Rule | apid.AddRuleOption): Rule {
        ...
        if (typeof rule.encodeOption !== 'undefined') {
            ...
            convertedRule.cmCut1 = rule.encodeOption.cmCut1 === true;
            ...
            convertedRule.cmCut2 = rule.encodeOption.cmCut2 === true;
            ...
            convertedRule.cmCut3 = rule.encodeOption.cmCut3 === true;
    ...
    private convertDBRuleToRule(rule: Rule): RuleWithCnt {
        ...
        if (rule.mode1 !== null) {
            ...
            encodeOption.cmCut1 = rule.cmCut1;
        }
        ...
        if (rule.mode2 !== null) {
            ...
            encodeOption.cmCut2 = rule.cmCut2;
        }
        ...
        if (rule.mode3 !== null) {
            ...
            encodeOption.cmCut3 = rule.cmCut3;
        }
