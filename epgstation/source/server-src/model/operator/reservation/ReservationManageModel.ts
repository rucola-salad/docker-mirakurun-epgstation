...
class ReservationManageModel implements IReservationManageModel {
    ...
    private setEncodeOptionToReserve(reserve: Reserve, encodeOption: apid.ReserveEncodedOption | undefined): void {
        if (typeof encodeOption === 'undefined') {
            ...
            reserve.encodeCmCut1 = false;
            reserve.encodeCmCut2 = false;
            reserve.encodeCmCut3 = false;
        ...
        reserve.encodeCmCut1 = encodeOption.cmCut1 === true;
        reserve.encodeCmCut2 = encodeOption.cmCut2 === true;
        reserve.encodeCmCut3 = encodeOption.cmCut3 === true;
