...
import ExtensionSettingsModel from './extensionSettings/ExtensionSettingsModel';
...
export const set = (container: Container): void => {
    ...
    container.bind<IExtensionSettingsModel>('IExtensionSettingsModel').to(ExtensionSettingsModel).inSingletonScope();
