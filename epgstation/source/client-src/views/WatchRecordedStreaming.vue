        ...
        <transition name="page">
            <div class="video-container-wrap mx-auto">
                <VideoContainer
                    ...
                    v-bind:recordedJikkyoVideoFileId="videoParam.videoFileId"
                ...
                <div v-if="videoParam !== null" class="chapter-edit-panel pa-3">
...
export default class WatchRecordedStreaming extends Vue {
    ...
    public get recordedId(): apid.RecordedId | null {
        return this.videoParam === null ? null : this.videoParam.recordedId;
    }
    ...
    public stopFrameStep(refreshPreview: boolean = true): void {
        /*
         * frameStepTimer が生成済みなら長押し状態。
         * 短押しでは startFrameStep() の最初の1フレームで既に
         * JPEGを取得しているため、mouseup時には再取得しない。
         */
