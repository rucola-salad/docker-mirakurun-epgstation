                ...
                <v-expansion-panel v-if="manualReserveState.isEnableEncodeMode() === true">
                    ...
                    <v-expansion-panel-content>
                        <SearchOptionRow>
                            ...
                            <v-checkbox
                                v-model="manualReserveState.encodeOption.cmCut1"
                                :disabled="manualReserveState.encodeOption.mode1 === null"
                                class="mx-1 my-0"
                                label="CMカット"
                            ></v-checkbox>
                        </SearchOptionRow>
                ...
                <v-expansion-panel v-if="manualReserveState.isEnableEncodeMode() === true">
                    ...
                    <v-expansion-panel-content>
                        <SearchOptionRow>
                            ...
                            <v-checkbox
                                v-model="manualReserveState.encodeOption.cmCut2"
                                :disabled="manualReserveState.encodeOption.mode2 === null"
                                class="mx-1 my-0"
                                label="CMカット"
                            ></v-checkbox>
                        </SearchOptionRow>
                ...
                <v-expansion-panel v-if="manualReserveState.isEnableEncodeMode() === true">
                    ...
                    <v-expansion-panel-content>
                        <SearchOptionRow>
                            ...
                            <v-checkbox
                                v-model="manualReserveState.encodeOption.cmCut3"
                                :disabled="manualReserveState.encodeOption.mode3 === null"
                                class="mx-1 my-0"
                                label="CMカット"
                            ></v-checkbox>
                        </SearchOptionRow>
