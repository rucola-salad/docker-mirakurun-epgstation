                    ...
                    <v-expansion-panel v-if="searchState.isEnableEncodeMode() === true">
                        ...
                        <v-expansion-panel-content>
                            <SearchOptionRow>
                                ...
                                <v-checkbox
                                    v-model="searchState.encodeOption.cmCut1"
                                    :disabled="searchState.encodeOption.mode1 === null"
                                    class="mx-1 my-0"
                                    label="CMカット"
                                ></v-checkbox>
                            </SearchOptionRow>
                    ...
                    <v-expansion-panel v-if="searchState.isEnableEncodeMode() === true">
                        ...
                        <v-expansion-panel-content>
                            <SearchOptionRow>
                                ...
                                <v-checkbox
                                    v-model="searchState.encodeOption.cmCut2"
                                    :disabled="searchState.encodeOption.mode2 === null"
                                    class="mx-1 my-0"
                                    label="CMカット"
                                ></v-checkbox>
                            </SearchOptionRow>
                    ...
                    <v-expansion-panel v-if="searchState.isEnableEncodeMode() === true">
                        ...
                        <v-expansion-panel-content>
                            <SearchOptionRow>
                                ...
                                <v-checkbox
                                    v-model="searchState.encodeOption.cmCut3"
                                    :disabled="searchState.encodeOption.mode3 === null"
                                    class="mx-1 my-0"
                                    label="CMカット"
                                ></v-checkbox>
                            </SearchOptionRow>
