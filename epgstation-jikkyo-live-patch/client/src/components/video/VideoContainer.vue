                        ...
                        <div class="video-control">
                            <div class="content" v-on:click="stopPropagation">
                                ...
                                <div class="d-flex align-center overflow-hidden mx-2">
                                    ...
                                    <v-btn
                                        v-if="typeof jikkyoChannelId !== 'undefined' && isJikkyoAvailable === true"
                                        icon
                                        dark
                                        class="jikkyo-icon"
...
export default class VideoContainer extends Vue {
    ...
    public isJikkyoEnabled: boolean = localStorage.getItem('epgstation-jikkyo-enabled') !== 'false';
    ...
    public switchJikkyo(): void {
        ...
        localStorage.setItem('epgstation-jikkyo-enabled', this.isJikkyoEnabled ? 'true' : 'false');
    }
